...
theta_C_levels = np.arange(-40,100,10)
...
x_mixing_ratios = [x_from_Tp(Bolton.mixing_ratio_line(mixing_ratios_i, p_all)+C_to_K, p_all) for mixing_ratios_i in mixing_ratios]
...
#ax.contour(x_from_Tp(mesh_T+C_to_K, mesh_p), y_from_p(mesh_p), theta_e_mesh, theta_e, colors = moist_colors)
